...
(def lines
  {;settings
   ...
   "If you leave empty a number will be assigned"  "If you leave empty a number will be assigned."
   ...
   "If this is closed, the user cannot place order via IVR." "If this is closed, the user cannot place order via IVR."
   ;"Open" "Açık"
   "Closed" "Closed"
  ...
  ;Employee.cljs
   ...
   "Carrier Name & Surname" "Carrier's Name & Surname"
   "Phone" "Phone"
   "Color" "Color"
   "Status" "Status"
   ...
   "Nonsellable items can be tracked. Customers can't see them." "Nonsellable items can be tracked. Customers can't see them."
...
(def new-lines
  {;29 Apr 2021
   ...
   "Phones" "Phones"
   "Delivering" "Delivering"
   "Open" "Open" ; as in: "Open this box to see inside."
